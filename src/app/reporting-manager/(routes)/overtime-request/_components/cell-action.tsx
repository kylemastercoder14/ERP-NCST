...
import { approveExtraShift, deleteExtraShift } from "@/actions";
import { Modal } from '@/components/ui/modal';
import RejectOvertimeForm from '@/components/forms/reject-overtime-form';
  ...
  return (
    <>
      ...
      <AlertModal
        onConfirm={onApprove}
        isOpen={approveModal}
        description="Do you want to approve this overtime?"
      ...
      <Modal
        ...
        description="Do you want to reject this overtime?"
      >
        <RejectOvertimeForm overtimeId={id} onClose={() => setRejectModal(false)} />
      </Modal>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => router.push(`/reporting-manager/overtime-request/${id}`)}
          >
