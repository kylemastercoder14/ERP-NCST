...
export function CustomerServiceTrainingForm({
  employeeId,
  employeeName,
  jobTitle,
  assessor,
  ...
  const [evaluations, setEvaluations] = useState<EvaluationCriteria[]>([
    ...
    },
    {
      ...
      description:
        "Maintains professional appearance and behavior at all times. Adheres to dress code and company standards.",
      rating: null,
    },
    {
      id: "3",
      ...
      description:
        "Ability to handle difficult situations calmly and professionally. Effectively de-escalates tense situations.",
      rating: null,
    },
    {
      id: "4",
      name: "Customer Focus",
      description:
        "Demonstrates genuine concern for customer needs. Provides excellent service and builds positive relationships.",
      rating: null,
    },
    {
      id: "5",
      ...
      description:
        "Identifies issues and implements appropriate solutions. Makes sound decisions in customer service scenarios.",
      rating: null,
    },
    {
      id: "6",
      ...
      description:
        "Thorough understanding of company services, policies, and procedures. Able to answer customer questions accurately.",
      rating: null,
    },
    {
      id: "7",
      name: "Adaptability",
      description:
        "Adjusts approach to meet different customer needs and situations. Handles unexpected challenges effectively.",
      rating: null,
    },
    {
      id: "8",
      name: "Teamwork",
      description:
        "Works well with colleagues and supervisors. Supports team goals and maintains positive working relationships.",
      rating: null,
    },
    {
      id: "9",
      name: "Compliance",
      description:
        "Follows company policies and procedures consistently. Adheres to all security protocols and regulations.",
      rating: null,
    },
    {
      id: "10",
      ...
      description:
        "Maintains composure under pressure. Handles multiple tasks and difficult customers without becoming flustered.",
      rating: null,
    },
  ]);
  ...
  const generateSummary = (): string => {
    ...
    if (average >= 4.5) return "Exceptional customer service skills";
    if (average >= 4) return "Highly proficient service provider";
    if (average >= 3) return "Meets service standards";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(`Assessment submitted successfully! Status: ${status}`);
      router.refresh();
      onClose();
    } catch (error) {
  ...
  return (
    <div className="max-w-7xl h-[90vh] overflow-y-auto mx-auto p-6 bg-white border shadow-lg rounded-lg">
      ...
      <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
        ...
        <p className="mt-2 text-sm text-blue-600 text-center font-semibold">
          Minimum passing average: 3.0
        </p>
      </div>
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-lg">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            <p className="text-sm text-gray-600">Service Proficiency:</p>
