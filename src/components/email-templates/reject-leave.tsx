	  ...
	  <Container style={container}>
		<Section style={coverSection}>
		  ...
		  <Section style={upperSection}>
			...
			<Text style={mainText}>
			  We are sad to inform you that your leave request has been rejected. Due to the following reason:
			</Text>
			<Section style={verificationSection}>
			  <Text style={verifyText}>{reason}</Text>
			</Section>
		  </Section>
		  <Hr />
...
export const RejectLeaveHTML = (props: RejectLeaveProps) =>
  render(<RejectLeave {...props} />, {
	pretty: true,
  });
